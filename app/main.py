...
def _apply_filters(stmt, q: str, kind: str, ext: str, category: str, needs_review: str, person: str, hide_junk: bool):
    if q:
        like = f"%{q.lower()}%"
...
async def ui_list(
    ...
    async with SessionLocal() as db:
        ...
        base = _apply_filters(base, q, kind, ext, category, needs_review, person, hide_junk)
